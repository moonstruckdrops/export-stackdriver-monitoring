...
#  description: "sidekiq job processed count.",
  columns: ["queue"] #=> tagsのキーと紐づく
)

# ここで時系列データになる値を設定
# このとき、tagsのキーがviewとmeasureデータを紐付ける役割を担う
# tagsのvalueは対象の項目名(ターゲットと読み替えてもいいかも)
measurement = sidekiq_processed_view.measure.create_measurement(value: 74556639, tags: { "queue" => "default" })
measurement_worker = sidekiq_processed_view.measure.create_measurement(value: 74566639, tags: { "queue" => "test_worker" })
